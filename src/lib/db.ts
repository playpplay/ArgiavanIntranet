...
export const LEGAL_SHORT =
  "Собственность Аргского Королевства • Ст. 123 ROTTO • КГТ Ст. 1 (187): трафик анализируется ГНИЦСТ";

export const LEGAL_FULL = [
  "Настоящая информационная сеть является собственностью Аргского Королевства.",
  "В соответствии со Статьёй 123 ROTTO любое лицо, находящееся в цифровом или физическом периметре АК, обязано соблюдать законы Королевства.",
  ...
  "Использование сети для распространения КГТ, критики монархического строя или организации несанкционированных собраний влечёт уголовную ответственность по Ст. 2 (66) и Ст. 3 (67) УК АК.",
];
...
function seed(): DB {
  return {
    ...
    domains: [
      ...
      { name: "post", tld: "arg", kind: "mail", owner: "krol", desc: "КЭП — Королевская электронная почта для граждан и ЮЛ.", port: 8003, system: true, createdAt: NOW - 255 * D },
