...
const AGENCIES = {
  kustos: {
    ...
    motto: "«ПОРЯДОК ЕСТЬ ОСНОВА КОРОЛЕВСТВА»",
  },
  kustodia: {
    title: "ГВАРДИЯ",
  ...
  ante: {
    ...
    desc: "Военный контур (Tęrra-an / Cię-an) объединяет штабные узлы армии Королевства. Сведения о дислокации, учениях и вооружении засекречены по КГТ.",
